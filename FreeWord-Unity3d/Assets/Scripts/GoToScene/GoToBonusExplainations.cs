...
public class GoToBonusExplainations : MonoBehaviour {
    ...
    public void Load()
    {
        ...
        init.name = "GoToBonusExplainations";
        init.AddComponent<GoToBonusExplainations>();
        GoToBonusExplainations scr = init.GetComponent<GoToBonusExplainations>();
        scr.start = true;
    }
	...
	void OnGUI () {
        ...
        {
            SceneManager.LoadSceneAsync("BonusExplainations");
