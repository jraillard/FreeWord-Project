...
public class GoToDevelopersInformations : MonoBehaviour {
    ...
    public void Load()
    {
        ...
        init.name = "GoToDevelopersInformations";
        init.AddComponent<GoToDevelopersInformations>();
        GoToDevelopersInformations scr = init.GetComponent<GoToDevelopersInformations>();
        scr.start = true;
    }
	...
	void OnGUI () {
        ...
        {
            SceneManager.LoadSceneAsync("DevelopersInformations");
