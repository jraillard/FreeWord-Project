...
public class GoToWordInformation : MonoBehaviour {
    ...
    public void Load()
    {
        ...
        init.name = "GoToWordInformation";
        init.AddComponent<GoToWordInformation>();
        GoToWordInformation scr = init.GetComponent<GoToWordInformation>();
        scr.start = true;
    }
	...
	void OnGUI () {
        ...
        {
            SceneManager.LoadSceneAsync("WordInformation");
