...
public class GoToWordCreation : MonoBehaviour {
    ...
    public void Load()
    {
        ...
        init.name = "GoToWordCreation";
        init.AddComponent<GoToWordCreation>();
        GoToWordCreation scr = init.GetComponent<GoToWordCreation>();
        scr.start = true;
    }
