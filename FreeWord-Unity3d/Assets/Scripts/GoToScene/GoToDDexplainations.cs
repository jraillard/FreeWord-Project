...
public class GoToDDexplainations : MonoBehaviour {
    ...
    public void Load()
    {
        ...
        init.name = "GoToDDexplainations";
        init.AddComponent<GoToDDexplainations>();
        GoToDDexplainations scr = init.GetComponent<GoToDDexplainations>();
        scr.start = true;
    }
	...
	void OnGUI () {
        ...
        {
            SceneManager.LoadSceneAsync("DDexplainations");
