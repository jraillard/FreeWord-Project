...
public class GoToAchievements : MonoBehaviour {
    ...
    public void Load()
    {
        ...
        init.name = "GoToAchievements";
        init.AddComponent<GoToAchievements>();
        GoToAchievements scr = init.GetComponent<GoToAchievements>();
        scr.start = true;
    }
	...
	void OnGUI () {
        ...
        {
            SceneManager.LoadSceneAsync("Achievements");
