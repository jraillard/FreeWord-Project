...
public class GoToLanguageToLearn : MonoBehaviour {
    ...
    public void Load()
    {
        ...
        init.name = "GoToLanguageToLearn";
        init.AddComponent<GoToLanguageToLearn>();
        GoToLanguageToLearn scr = init.GetComponent<GoToLanguageToLearn>();
        scr.start = true;
    }
	...
	void OnGUI () {
        ...
        {
            SceneManager.LoadSceneAsync("LanguageToLearn");
